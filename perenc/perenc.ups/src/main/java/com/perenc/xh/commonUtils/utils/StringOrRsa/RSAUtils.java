...
public class RSAUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String messageEn = encryptByPrivate(message);
        System.out.println(message + "\t加密后的字符串为:" + messageEn);
        String messageDe = decryptByPrivate(messageEn);
        System.out.println("还原后的字符串为1:" + messageDe);
        String messageDe1 = decryptByPrivate("U2zvs2RbJRVR4z+KHuMLCyQz+rer4Hd5UVNxrzQiKsUT+Oa3jWrzsm8dpLIInQ/S+lTf+hj2lpeoxhah/y1wqbwE7HL1spBcodTkzm1gjkRRe1p2Y+oYrLQAff42iTsAM+XaETzZ6j+sSMcnXoTNoljNrw56ftKGsBEdvACpb1o=");
        System.out.println("还原后的字符串为2:" + messageDe1);*/

        String message = "52freeparking";
        //String message = "数表的质数又称素数。指整数在一个大于1的自然数中，除了1和此整数自身外，没法被其他自然数整除的数";
        System.out.println("随机生成的公钥为:" + publicKeyStr);
        System.out.println("随机生成的私钥为:" + privateKeyStr);
        String messageEn = encryptByPrivate(message);
        System.out.println(message + "\t加密后的字符串为:" + messageEn);
        String messageDe = decryptByPublic(messageEn);
        System.out.println("还原后的字符串为1:" + messageDe);

        String messageDe21 = decryptByPublic("Nb1Fdq9OQ5yLl5gPcb6sd7mdBJi2lTAOeq/i6DyehqXpl4FbgpXdWbzqW0peQPDWIye9h/JHLL6nZyy7+wzS4G8GBJ4GaTTXvZgZzrA8q97AREdAEvB+dpzHoasBKXtLgDRVufv2OHswx4Q58mnOEOCb4ur1MHsmboNlwcowwCE=");
        System.out.println("还原后的字符串为2:" + messageDe21);
    }
    /**
     * 随机生成密钥对
     ...
     *             解密过程中的异常信息
     */
    public static String decryptByPublic(String str) throws Exception{
        //64位解码加密后的字符串
        byte[] inputByte = Base64.decodeBase64(str.getBytes("UTF-8"));
        //base64编码的私钥
        byte[] decoded = Base64.decodeBase64(publicKeyStr);
