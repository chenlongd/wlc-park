...
@Controller
@RequestMapping("api/sellerFreecar")
public class TcSellerFreecarController {
    ...
    public ReturnJsonData add(HttpServletRequest request, HttpServletResponse response) throws Exception{
        ...
        tcSellerFreecar.setSellerUserId(Integer.valueOf(sellerUserId));
    ...
    @ResponseBody
    @OperLog(operationType="商家指定免费车",operationName="修改时间")
    public ReturnJsonData updateTime(HttpServletRequest request, HttpServletResponse response) throws Exception{
        ...
        tcSellerFreecar.setSdate(sdate);
        tcSellerFreecar.setEdate(edate);
        return tcSellerFreecarService.updateTime(tcSellerFreecar);
    }
