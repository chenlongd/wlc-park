package com.perenc.xh.lsp.controller.admin.tcFileUpload;
...
public class AdminTcFileUploadController {

	Logger logger = Logger.getLogger(AdminTcFileUploadController.class);
