package com.perenc.xh.lsp.controller.phone.tcFileUpload;

import com.perenc.xh.commonUtils.model.DataCodeUtil;
import com.perenc.xh.commonUtils.model.PhoneReturnJson;
import com.perenc.xh.commonUtils.model.ReturnJsonData;
import com.perenc.xh.commonUtils.utils.aliyunoss.AliyunUploadImageCreateFolder;
...
@Controller
@RequestMapping("api/tcfile")
public class TcFileUploadController {

	Logger logger = Logger.getLogger(TcFileUploadController.class);
	...
	public String updateHead(MultipartFile file) throws IOException{
		...
		AliyunUploadImageCreateFolder aliyunUploadImageCreateFolder = new AliyunUploadImageCreateFolder();
		String name = aliyunUploadImageCreateFolder.uploadImgOss(file);
		String imgUrl = aliyunUploadImageCreateFolder.getImgUrl(name);
		return imgUrl;
	}
